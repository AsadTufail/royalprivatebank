...
$am=$_POST['amount'];
$bl=$_POST['balance'];
if($bl=='check') { $bl=$awa;} else if($bl=='save') { $bl=$accb2;}
...
if($loc==0){ echo "<script type='text/javascript'>
...
splashmessage[14]='50%<BR>OF PIN REQUEST GRANTED<br>'
