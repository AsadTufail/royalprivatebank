                                ...
                                <td><strong style='color:green;'>";
                                                                ...
                                                                if ($result->num_rows > 0) {
                                                                  while ($row = $result->fetch_assoc()) {
                                                                    $acc_c = $row["accn"];
                                                                    if (isset($acc_c)) {
                                                                      $queryv2 = "SELECT SUM(anount) AS rtv2 FROM logs WHERE  client = '$aus' AND  status ='completed' AND tp='check' AND accn='$acc_c' ";
                                                                      ...
                                                                      $queryvz2 = "SELECT SUM(anount) AS rtvz2 FROM logs WHERE  client = '$aus' AND  status ='debited' AND tp='check' AND accn='$acc_c' ";
                                                                      ...
                                                                      echo "Checking: $$awamoney2 ($acc_c)<br>";
                                                                    }
                                                                  }
                                                                }
                                                                ...
                                                                if ($result->num_rows > 0) {
                                                                  while ($row = $result->fetch_assoc()) {
                                                                    ...
                                                                    if (isset($acc_s)) {
                                                                      ...
                                                                      echo "Savings: $$awamoney3 ($acc_s)<br>";
                                                                    }
                                                                  }
                                                                }
